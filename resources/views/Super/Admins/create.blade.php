...
<style>
    ...
    .dark .form-group input, .dark .form-group select, .dark .form-group input[type="file"] { background: var(--white); }
</style>
...
<div class="rms-wrap">
    ...
    <div class="rms-form-card">
        ...
        <div class="rms-form-body">
            ...
            <form method="POST" action="{{ route('super.admins.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="hint">Upload a profile picture (optional)</div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Contact</label>
                        <input type="text" name="contact" value="{{ old('contact') }}" placeholder="01XXXXXXXXX">
                    </div>

                <div class="form-row single">
                    <div class="form-group">
                        <label>Email Address <span style="color:var(--rose);">*</span></label>
                        <input type="email" name="email" value="{{ old('email') }}" required placeholder="admin@company.com">
                    </div>
                </div>
